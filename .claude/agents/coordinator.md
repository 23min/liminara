...
3. **Adopt the target agent role** — Read the target agent's `.claude/agents/<agent>.md` file and follow its skill workflow:
   - Planning, specs, architecture → read and follow `.claude/agents/planner.md`
   - Implementation, fixes, TDD → read and follow `.claude/agents/builder.md`
   - Code review, validation → read and follow `.claude/agents/reviewer.md`
   - Releases, deployment → read and follow `.claude/agents/deployer.md`
