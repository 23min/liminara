---
title: Liminara Phase 3 Reference Architecture
...
*This document is a point-in-time snapshot after Phase 3. For the evolving architecture, see [../../architecture/01_CORE.md](../../architecture/01_CORE.md). For the current source map and sequencing rules, see [../../architecture/02_PLAN.md](../../architecture/02_PLAN.md) and [../../../work/roadmap.md](../../../work/roadmap.md).*
