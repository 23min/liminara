...
Archived snapshot. Current sequencing lives in `work/roadmap.md`, and the active source map lives in `docs/architecture/02_PLAN.md`.

**Status:** Archived snapshot. This document does not track current sequencing.
...
*This archived document preserves the 2026-03-19 plan snapshot. For settled strategic decisions, see [10_Synthesis.md](../../analysis/10_Synthesis.md). For the current runtime architecture, see [01_CORE.md](../../architecture/01_CORE.md).*
