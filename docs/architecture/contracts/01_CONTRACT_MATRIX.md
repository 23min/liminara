...
| Warning and degraded-success contract | No first-class runtime warning contract yet; current behavior is ordinary success or failure only | `work/done/E-20-execution-truth/M-TRUTH-01-execution-spec-outcome-design.md`, `work/done/E-20-execution-truth/M-TRUTH-02-core-runtime-contract-migration.md`, `work/done/E-19-warnings-degraded-outcomes/epic.md` | Radar fallback behavior and prior notes | Warning/degraded runtime work starts after M-TRUTH-02; no UI-only or decision-shaped warning side channel is allowed |
