...
3. **Adopt the target agent role** — Read the target agent's `.ai/agents/<agent>.md` file and follow its skill workflow:
   - Planning, specs, architecture → read and follow `.ai/agents/planner.md`
   - Implementation, fixes, TDD → read and follow `.ai/agents/builder.md`
   - Code review, validation → read and follow `.ai/agents/reviewer.md`
   - Releases, deployment → read and follow `.ai/agents/deployer.md`
