...
| M-CS-04-cli-and-report | CLI (list, verify, report), Article 12 report generator (json/human/markdown) | done |
| M-CS-05-example-01 | Raw Python + Anthropic SDK example (uninstrumented vs instrumented), demo script | ready |
